<div class="row layout-top-spacing">
                    ...
                    <table class="tablet table-striped table-bordered mt-1 col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-1">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center text-dark">
                                ...
                                <td>{{$education->title_obtained}}</td>
                                <td>{{\Carbon\Carbon::parse($education->date)->format('d-m-Y')}}</td>	
                                <td>
                                                ...
                                                <div class="select-dropdown">
                                                    @if ($showDeleted)
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            wire:click="restoreRow('{{ $education->id }}')">
                                                            <i class="bi bi-arrow-counterclockwise"></i> Restaurar
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item text-danger" href="javascript:void(0)"
                                                            wire:click="deleteRowPerm('{{ $education->id }}')">
                                                            <i class="bi bi-trash"></i> Eliminar Completo
                                                        </a>
                                                    @else
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            wire:click="Edit({{ $education->id }})">
                                                            <i class="bi bi-pencil"></i> Editar
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item text-danger" href="javascript:void(0)"
                                                            wire:click="deleteRow('{{ $education->id }}')">
    ...
    @include('livewire.backend.educations.form')
</div>
