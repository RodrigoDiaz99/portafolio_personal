                ...
                <div class="row">
                    <div class="col-12 col-md-7 col-lg-7">
                        <div class="form-group">
                            <label class="text-dark">Empresa <i class="text-danger">*</i> @error('name') <span class="text-danger er">{{$message}}</span>@enderror</label>
                            <input type="text" wire:model.lazy='name' class="form-control">
                        </div>
                    </div>
                    <div class="col-12 col-md-5 col-lg-5">
                        <div class="form-group">
                            <label class="text-dark">Puesto de trabajo <i class="text-danger">*</i> @error('job') <span class="text-danger er">{{$message}}</span>@enderror</label>
                            <input type="text" wire:model.lazy='job' class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="text-dark">Desde  @error('from') <span class="text-danger er">{{$message}}</span>@enderror</label>
                            <input type="date" wire:model.lazy='from' class="form-control" maxlength="11" placeholder="Ej: 01-12-1990">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="text-dark">Hasta  @error('to') <span class="text-danger er">{{$message}}</span>@enderror</label>
                            <input type="date" wire:model.lazy='to' class="form-control" maxlength="11" placeholder="Ej: 01-12-1990">
                        </div>
                    </div>
                </div>
                <div class="row">
