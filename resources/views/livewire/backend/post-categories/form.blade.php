            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-8">
                        <div class="form-group">
                            <label for="name" class="text-dark">Nombre <i class="text-danger">*</i> @error('name')
                    ...
                    <div class="col-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea rows="8" class="form-control " id="description" name="description" wire:model.defer='description'></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="resetUI()"
                        class="btn btn-sm btn-border border btn-outline-dark btn-responsive close-modal"
                        data-dismiss="modal">
                        CERRAR
                    </button>
