    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="input-group border" wire:ignore>
                                <input type="password" id="current_password" wire:model.lazy="current_password" class="form-control form-fond">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="input-group border" wire:ignore>
                                <input type="password" id="new_password" wire:model.lazy="new_password" class="form-control form-fond">
                                <div class="input-group-append">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="input-group border" wire:ignore>
                                <input type="password" id="new_password_confirmation" wire:model.lazy="new_password_confirmation" class="form-control form-fond">
                                <div class="input-group-append">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="resetUI()" class="btn btn-sm btn-border border btn-outline-dark btn-responsive close-modal close-modal" data-dismiss="modal">
                CERRAR
                </button>
